  ...
  <VRow>
        ...
        <VCardText class="position-relative">
          ...
          <div class="d-flex justify-space-between flex-wrap pt-8">
            <div class="me-2 mb-2">
              ...
              <VCardSubtitle class="sendText-caption pa-0">
                London, UK
              </VCardSubtitle>
            </div>
      ...
      <VCard>
        <div class="d-flex justify-space-between flex-wrap flex-md-nowrap flex-column flex-md-row">
          ...
          <div>
            ...
            <VCardText class="sendText-subtitle-1">
      ...
      <VCard>
        <div class="d-flex flex-column-reverse flex-md-row">
          <div>
            ...
            <VCardText class="d-flex align-center flex-wrap sendText-body-1">
              <VRating
                :model-value="5"
                readonly
                class="me-3"
    ...
    >
      <VCard>
        ...
        <VCardText>
          <p class="font-weight-medium sendText-base">
            $249.40
          </p>
      ...
      <VCard>
        <VRow no-gutters>
          ...
          <VCol
            ...
            order="1"
            order-lg="2"
            class="member-pricing-bg sendText-center"
          >
            <div class="membership-pricing d-flex flex-column align-center py-14 h-100 justify-center">
              <p class="mb-5">
                <sub class="sendText-h5">$</sub>
                <sup class="sendText-h2 font-weight-medium">899</sup>
                <sub class="sendText-h5">USD</sub>
              </p>
      ...
      <VCard title="The Best Answers">
        <VCardText class="d-flex align-center flex-wrap">
          <VRating
            ...
            class="me-3"
          />
          <span class="sendText-subtitle-2">5 Star | 98 reviews</span>
        </VCardText>
