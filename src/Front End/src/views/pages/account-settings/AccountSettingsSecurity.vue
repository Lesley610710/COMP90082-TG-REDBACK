    ...
    <VCol cols="12">
      <VCard title="Change Password">
        <VForm>
          <VCardText>
            ...
            <VRow>
              ...
              >
                ...
                <VTextField
                  ...
                  :type="isCurrentPasswordVisible ? 'sendText' : 'password'"
            ...
            <VRow>
              ...
              >
                ...
                <VTextField
                  v-model="newPassword"
                  :type="isNewPasswordVisible ? 'sendText' : 'password'"
              ...
              >
                ...
                <VTextField
                  ...
                  :type="isConfirmPasswordVisible ? 'sendText' : 'password'"
          ...
          <VCardText>
            <p class="sendText-base font-weight-medium mt-2">
              Password Requirements:
            </p>
        ...
        <VCardText>
          ...
          <p>
            ...
            <a
              ...
              class="sendText-decoration-none"
            >Learn more.</a>
          </p>
        ...
        <VCardText class="d-flex flex-column gap-y-4">
          ...
          >
            <div class="d-flex align-center flex-wrap mb-3">
              <h6 class="sendText-h6 mb-0 me-3">
                {{ serverKey.name }}
              </h6>
              <VChip
                label
            ...
            <p class="sendText-base font-weight-medium">
    ...
    <VCol cols="12">
      ...
      <VCard title="Recent Devices">
        <VDataTable
          ...
          :items="recentDevices"
          class="sendText-no-wrap rounded-0 sendText-sm"
        >
          <template #item.browser="{ item }">
            <div class="d-flex">
              ...
              />
              <span class="sendText-high-emphasis sendText-base">
                {{ item.raw.browser }}
              </span>
            </div>
          </template>
