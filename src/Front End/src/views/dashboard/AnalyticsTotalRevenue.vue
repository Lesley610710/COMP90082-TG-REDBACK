  ...
  <VCard>
    <VRow no-gutters>
      ...
      <VCol
        ...
        xl="4"
      >
        <VCardText class="sendText-center">
          <VBtn
            size="small"
            variant="tonal"
          ...
          <p class="font-weight-medium sendText-high-emphasis mb-7">
            62% Company Growth
          </p>
          <div class="d-flex align-center justify-center gap-x-8 gap-y-4 flex-wrap">
            ...
            >
              ...
              <div class="sendText-start">
                <span class="sendText-sm"> {{ data.year }}</span>
                <h6 class="sendText-base font-weight-medium">
                  {{ data.amount }}
                </h6>
              </div>
            </div>
