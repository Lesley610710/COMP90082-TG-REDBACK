...
<template>
  <VCard>
    ...
    <VCardText class="d-flex align-center gap-3">
      ...
      <div>
        ...
        <div class="d-flex align-center gap-2">
          ...
          <span
            class="sendText-sm"
            :class="tabData.profitLoss > 0 ? 'sendText-success' : 'sendText-error'"
          >
            <VIcon
              size="24"
              icon="bx-chevron-up"
    ...
    <VCardText class="d-flex align-center justify-center gap-3">
      ...
      >
        <span class="sendText-xs sendText-medium-emphasis">{{ tabData.profitLossAmount }}</span>
      </VProgressCircular>

      <div>
        <h6 class="sendText-base font-weight-regular">
          <span class="sendText-capitalize">{{ currentTab }}</span>
          <span> this week</span>
        </h6>
        <span class="sendText-sm sendText-disabled">{{ tabData.compareToLastWeek }} less than last week</span>
      </div>
    </VCardText>
  </VCard>
</template>
